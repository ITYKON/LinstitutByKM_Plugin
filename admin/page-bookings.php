    ...
    <div class="ib-admin-content">
      ...
      <?php if ($edit_booking): ?>
          ...
          <form method="post" autocomplete="off">
            ...
            <div class="ib-form-grid">
              <div class="ib-form-group">
                ...
                <label class="ib-label" for="edit-booking-client-name">Nom</label>
              </div>
              <!-- <div class="ib-form-group">
                <input class="ib-input" id="edit-booking-client-lastname" name="client_lastname" value="<?php echo esc_attr($edit_booking->client_lastname); ?>" placeholder=" " required>
                <label class="ib-label" for="edit-booking-client-lastname">Prénom</label>
              </div> -->
              <div class="ib-form-group">
        ...
        <script>
          ...
          document.getElementById('ib-modal-bg-booking').onclick = function() {
            document.body.style.overflow = '';
            window.location.href = 'admin.php?page=institut-booking-bookings';
          };
        </script>
      <?php endif; ?>
      ...
      <?php else: ?>
        <div style="display:flex;align-items:center;gap:1.2em;margin-bottom:1.2em;flex-wrap:wrap;">
          ...
          <select id="ib-booking-filter-employee" style="border-radius:10px;border:1.5px solid #fbeff3;padding:0.5em 1em;font-size:1.07em;color: #b95c8a;background: #fbeff3;">
            ...
            <?php $has_employe = false;
            foreach ($employees as $e): ?>
              <?php
              $role = isset($e->role) ? $e->role : '';
              $role_norm = normalize_role($role);
              if ($role_norm === 'employe' || $role === '' || $role === null) {
                $has_employe = true; ?>
        ...
        <div style="overflow-x:auto;">
          <table class="ib-table-bookings ib-invisible" style="width:100%;background:#fff;border-radius:14px;box-shadow:0 2px 16px #e9aebc22;margin-bottom:2em;">
            <thead style="background:#fbeff2;">
              <tr>
                <th style="color:#e9aebc;cursor:pointer;" data-sort="name">Nom <span class="sort-arrow"></span></th>
                <th style="color:#e9aebc;cursor:pointer;" data-sort="lastname">Prénom <span class="sort-arrow"></span></th>
                ...
                <tr>
                  ...
                  <td class="ib-action-btns" style="white-space:nowrap;display:flex;gap:0.5em;align-items:center;">
                    <a href="admin.php?page=institut-booking-bookings&action=edit&id=<?php echo $booking->id; ?>" class="ib-icon-btn edit" title="Éditer">
                      <svg width="20" height="20" fill="none" stroke="#e9aebc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                        <path d="M12 20h9" />
                    ...
                    <a href="admin.php?page=institut-booking-bookings&action=delete&id=<?php echo $booking->id; ?>" class="ib-icon-btn delete" title="Supprimer" onclick="return confirm('Supprimer cette réservation ?')">
                      <svg width="20" height="20" fill="none" stroke="#f8b4b4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
...
<style>
  ...
  .ib-table-bookings {
    background: #fff;
    border-radius: 14px;
    box-shadow: 0 2px 16px #e9aebc22;
    color: #b95c8a;
    font-size: 1.07em;
  }
  ...
  .ib-table-bookings td {
    border-bottom: 1px solid #fbeff3;
    padding: 0.7em 1em;
  }

  .ib-btn.accent {
    background: linear-gradient(90deg, #e9aebc 0%, #fbeff3 100%);
    color: #fff;
    border: none;
    border-radius: 16px;
    font-weight: 700;
  ...
  .ib-modal {
    background: #fff;
    border-radius: 2em;
    box-shadow: 0 12px 48px #e9aebc44;
    padding: 2.5em 2em 2em 2em;
    max-width: 600px;
    margin: 2em auto;
    animation: ib-modal-fadein 0.7s cubic-bezier(.4, 0, .2, 1);
  }
  ...
  @media (max-width: 600px) {
    ...
    .ib-table-bookings,
    .ib-table-bookings thead,
    .ib-table-bookings tbody,
  ...
  .ib-status-en_attente {
    ...
    border: #bfa600 !important;
  }

  .ib-status-confirmee {
    background: #e6ffed !important;
    color: #1ca97c !important;
    border: #1ca97c !important;
  }

  .ib-status-annulee {
    background: #ffeaea !important;
    color: #e05c5c !important;
    border: #e05c5c !important;
  }
  ...
  #ib-booking-search:focus {
    border-color: #b95c8a;
    background: #fff;
    color: #b95c8a;
    box-shadow: 0 2px 12px #e9aebc33;
  }
  ...
  #add-booking-client-phone,
  #edit-booking-client-phone {
    max-width: 260px;
    min-width: 160px;
    width: 100%;
  }
  ...
  #add-booking-country-select:focus,
  #edit-booking-country-select:focus {
    outline: none;
    border-color: #e9aebc;
  ...
  #add-booking-country-select option,
  #edit-booking-country-select option {
    padding: 8px;
    font-size: 13px;
    background: white;
    color: #333;
  ...
  #add-booking-country-select option:hover,
  #edit-booking-country-select option:hover {
    background: #f8f9fa;
  }

  #add-booking-country-select option:checked,
  #edit-booking-country-select option:checked {
    background: #e9aebc;
    color: white;
  }
