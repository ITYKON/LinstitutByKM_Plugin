<?php
// Inclure le handler AJAX pour la vérification du numéro
// require_once plugin_dir_path(__FILE__) . 'ajax-check-phone.php';
...
// Ajout du hook pour localiser les variables AJAX pour le JS
// Le JS de vérification téléphone est maintenant chargé via institut-booking.php (hook admin_enqueue_scripts)
        ...
        <form method="post" class="ib-booking-form-admin">
          <div style="width:260px;max-width:100%;margin-bottom:1.2em;">
            ...
            <div style="display:flex;align-items:center;">
              ...
              <div id="ib-phone-check-msg" style="margin-left:10px;font-size:13px;color:#b00;font-weight:bold;text-align:right;"></div>
            </div>
          </div>
  ...
  jQuery(function($) {
    ...
    function initSimplePhoneFields() {
      ...
      try {
        ...
        if ($('#add-booking-client-phone').length) {
          // Injection dynamique du +213 supprimée pour éviter le doublon
        }
      }
    }
