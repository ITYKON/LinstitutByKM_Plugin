...
let startTime, endTime;
    ...
    function debugCalendarData() {
        ...
        console.log('Heures d\'ouverture:', ibkCalendarData.opening_time, '-', ibkCalendarData.closing_time);
        console.groupEnd();
    }
    ...
    function initCalendar() {
        ...
        const { employees = [], services = [], categories = [], bookings = [], nonces = {} } = calendarData;
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventContent: function(arg) {
                ...
                titleEl.innerHTML = `
                    ...
                    ${event.extendedProps.employee ? `<div class="fc-event-employee">${event.extendedProps.employee}</div>` : ''}
                `;
            ...
            events: function(fetchInfo, successCallback, failureCallback) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        console.error('Erreur lors du chargement des événements:', data.data);
    ...
    function openEventModal(eventData = {}) {
        ...
        if (!eventData.id) {
            ...
            document.getElementById('event-start').value = formatDateTime(eventData.start);
            ...
            document.getElementById('event-modal-title').textContent = 'Nouveau rendez-vous';
            ...
            document.getElementById('event-end').value = formatDateTime(eventData.end);
            document.getElementById('event-all-day').checked = eventData.allDay || false;
            document.getElementById('event-notes').value = eventData.extendedProps.notes || '';
            ...
            // Mettre à jour le titre de la modale
            document.getElementById('event-modal-title').textContent = 'Modifier le rendez-vous';
    ...
    function saveEvent() {
        ...
        .then(result => {
            if (result.success) {
                ...
                showAlert('success', result.data.message || 'Événement enregistré avec succès');
            } else {
    ...
    function deleteEvent(eventId) {
        ...
        .then(result => {
            if (result.success) {
                ...
                // Afficher un message de succès
                showAlert('success', result.data.message || 'Événement supprimé avec succès');
            } else {
                // Afficher les erreurs
                showAlert('danger', result.data.message || 'Une erreur est survenue');
